        ...
        <>
            <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
                <Tooltip title="Account">
                    ...
                    >
                        <Avatar sx={{ bgcolor: amber[900] }}>{user && Object.keys(user).length !== 0 && user.name[0]}</Avatar>
                    </IconButton>
                </Tooltip>
            </Box>
            <Menu
            ...
            >
                ...
                <Link href={user.idproof} color="inherit" target="_blank" rel="noopener" underline="none">
                    <MenuItem>
                        <ListItemIcon>
                            <PermIdentityIcon />
                        </ListItemIcon>
